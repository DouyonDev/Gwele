...
class AjoutTacheReunion extends StatefulWidget {
  ...
  @override
  _AjoutTacheReunionState createState() => _AjoutTacheReunionState();

  AjoutTacheReunion({Key? key, required this.reunion}) : super(key: key);
}

class _AjoutTacheReunionState extends State<AjoutTacheReunion> {
  ...
  Future<void> _submitTask() async {
    ...
    String tacheId = await TacheService().ajouterTacheID(nouvelleTache);
    widget.reunion.tachesAssignees.add(tacheId);

    // Appel au service de modification de la reunion
    await ReunionService().mettreAJourReunion(widget.reunion);
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return MessageModale(
          ...
          content: "La tâche a été assignée.",
        );
      },
